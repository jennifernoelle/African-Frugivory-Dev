...
# Expert 0c
obs_OP <- ifelse(obs_OP == 0.75, 0.35, obs_OP)
obs_OP <- ifelse(obs_OP == 0.5, 0.25, obs_OP)
obs_OP <- ifelse(obs_OP == 0.45, 0.15, obs_OP)
obs_OP <- ifelse(obs_OP == 0.25, 0.1, obs_OP)
obs_OP <- ifelse(obs_OP == 0.1, 0.05, obs_OP)
obs_OP <- ifelse(obs_OP == 0.05, 0.025, obs_OP)
