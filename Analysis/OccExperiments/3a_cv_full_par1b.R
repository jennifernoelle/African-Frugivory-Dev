...
# Expert-defined occurrence 1b
obs_OP <- ifelse(obs_OP == 0.75, 0.25, obs_OP)
obs_OP <- ifelse(obs_OP == 0.5, 0.15, obs_OP) 
obs_OP <- ifelse(obs_OP == 0.25, 0.05, obs_OP) 
