...
# Expert 0a
obs_OP <- ifelse(obs_OP == 0.75, 0.65, obs_OP) # reduce same site co-occurrence prob
obs_OP <- ifelse(obs_OP == 0.45, 0.4, obs_OP) # reduce same region and habitat co-occurrence prob
