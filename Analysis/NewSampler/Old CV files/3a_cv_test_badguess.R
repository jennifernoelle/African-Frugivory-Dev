...
date <- 'July13_NewSampler_badguess'
...
Nsims <- 2000 #500 #1000 #5000 # original 10000, reasonable 2500
burn <-  5000 #2000 #5000 # 2000 # 22000 # original 40000, reasonable 2500
...
mh_n_pjs <- 70
mh_n_rho <- 100
mh_occ_sd <-  0.5 #0.175 #0.25 # increase prior variance if weak guess is used
mh_occ_step <- 1 #0.25 
