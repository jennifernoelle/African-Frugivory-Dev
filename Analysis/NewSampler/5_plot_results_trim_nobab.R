...
date <- 'Final_new_p75' # First seed failed to save properly
date <- 'Final_new_1mod'

# Do we want to save failes?
save_files <- TRUE
...
if(save_files == TRUE){write.csv(mean_pred, paste0(results_path, "PosteriorNetworks/net_", date, ".csv"))}
